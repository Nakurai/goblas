...
Best read roughly in this order — later ones reuse ideas from earlier ones.
...
If you are brand new, start with [linear-regression.md](linear-regression.md): it introduces
